...
class Tag
  class Work
    class RadioDramaSeason < ApplicationRecord
      self.table_name = 'tag_radio_drama_seasons'

      # Work Relations
      belongs_to :radio_drama_series, required: true, class_name: Tag::Work::RadioDramaSeries.name,
