...
RSpec.describe Tag::Work::StreamingSeason, type: :model do
  describe 'Associations' do
    it { is_expected.to belong_to(:streaming_series) }
  end
  ...
  describe 'Attributes' do
    describe '#slug' do
      ...
      it do
        create(:streaming_season, slug: 'A')
    ...
    describe '#old_slug' do
      it do
        create(:streaming_season, old_slug: 'A')
