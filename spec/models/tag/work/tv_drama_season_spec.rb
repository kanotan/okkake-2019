...
RSpec.describe Tag::Work::TvDramaSeason, type: :model do
  describe 'Associations' do
    it { is_expected.to belong_to(:tv_drama_series) }
  end
  ...
  describe 'Attributes' do
    ...
    describe '#old_slug' do
      it do
        create(:tv_drama_season, old_slug: 'A')
