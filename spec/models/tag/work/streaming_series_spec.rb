...
RSpec.describe Tag::Work::StreamingSeries, type: :model do
  describe 'Associations' do
    it { is_expected.to belong_to(:work) }
    it { is_expected.to have_many(:streaming_seasons) }
  end
  ...
  describe 'Attributes' do
    describe '#slug' do
      ...
      it do
        create(:streaming_series, slug: 'A')
    ...
    describe '#old_slug' do
      it do
        create(:streaming_series, old_slug: 'A')
