...
RSpec.describe Tag::Work::RadioDramaSeries, type: :model do
  describe 'Associations' do
    it { is_expected.to belong_to(:work) }
    it { is_expected.to have_many(:radio_drama_seasons) }
  end
  ...
  describe 'Attributes' do
    describe '#slug' do
      ...
      it do
        create(:radio_drama_series, slug: 'A')
    ...
    describe '#old_slug' do
      it do
        create(:radio_drama_series, old_slug: 'A')
