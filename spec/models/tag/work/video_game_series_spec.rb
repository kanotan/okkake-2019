...
RSpec.describe Tag::Work::VideoGameSeries, type: :model do
  describe 'Associations' do
    it { is_expected.to belong_to(:work) }
    it { is_expected.to have_many(:video_games) }
  end
  ...
  describe 'Attributes' do
    describe '#slug' do
      ...
      it do
        create(:video_game_series, slug: 'A')
    ...
    describe '#old_slug' do
      it do
        create(:video_game_series, old_slug: 'A')
